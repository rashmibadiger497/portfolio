  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 py-20 relative z-10">
      <div className="w-full max-w-md">
        ...
        <div className="glass-strong rounded-2xl p-8 glow-cyan">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-muted-foreground">
              {isLogin
                ? "Log in to access your portfolio and analysis tools."
                : "Start analyzing Indian stocks with professional tools."}
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3 mb-6">
            <button
              type="button"
              className="flex items-center justify-center gap-3 w-full py-2.5 rounded-lg border border-border bg-secondary/30 text-sm text-foreground hover:bg-secondary/50 transition-colors"
            >
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <Button
              type="submit"
              className="w-full bg-primary text-primary-foreground hover:bg-primary/90 py-5 text-sm font-semibold gap-2"
            >
        ...
        {/* Bottom text */}
        <p className="text-center text-xs text-muted-foreground mt-6 text-pretty leading-relaxed">
          By continuing, you agree to NovaStar&apos;s Terms of Service and Privacy
          Policy. Market data is for educational purposes only.
        </p>
      </div>
    </div>
  );
